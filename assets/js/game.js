var fightOrSkip = function() {
    ...
    if(promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            shop(); // not sure if this belongs here
        }
    }
...
var shop = function() {
    ...
    var shopOptionprompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store?  Please enter: '1 = REFILL', '2 = UPGRADE', or '3 = LEAVE' to make a choice."
    );
